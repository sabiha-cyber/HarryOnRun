...
1. Mute Option: Players can toggle the background music on or off, with visual indicators for the current state.
2. Leaderboard: The game records and displays the top five scores along with the players' names. To achieve this, I implemented a name input feature at the beginning of the game using the pygame_textinput library.
3. Navigation Controls: A back button allows seamless navigation between screens. This was implemented using a separate Button class in a button.py file.
